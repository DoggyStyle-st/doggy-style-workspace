...
const SW_VERSION = "M45_4G1_INBOX_TASK_OPTIONS_FIX_PACKED_20260208";
  ...
  try {
    event.waitUntil((async ()=>{
      ...
      for (const c of clients) {
        try { c.postMessage({type:'DS_SW_VERSION', value:'M45_4G1_INBOX_TASK_OPTIONS_FIX_PACKED_20260208'}); } catch(_ ){}
      }
    })());
  } catch(_ ){}
});
