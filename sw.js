...
const SW_VERSION = "M50.2_BLUE_TEMPLATE_PRINT_CONTRACT_20260215";
  ...
  try {
    event.waitUntil((async ()=>{
      ...
      for (const c of clients) {
        try { c.postMessage({type:'DS_SW_VERSION', value:'M50.2_BLUE_TEMPLATE_PRINT_CONTRACT_20260215'}); } catch(_ ){}
      }
    })());
  } catch(_ ){}
});
