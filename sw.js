...
const SW_VERSION = "M46_4G2_INBOX_TASKS_LOCALCUSTOMERS_20260208";
  ...
  try {
    event.waitUntil((async ()=>{
      ...
      for (const c of clients) {
        try { c.postMessage({type:'DS_SW_VERSION', value:'M46_4G2_INBOX_TASKS_LOCALCUSTOMERS_20260208'}); } catch(_ ){}
      }
    })());
  } catch(_ ){}
});
